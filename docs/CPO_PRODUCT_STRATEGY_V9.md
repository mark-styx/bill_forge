...
**Version:** 9.0 - Execution Strategy
...
Bill Forge enters the AP automation market with a clear thesis: **mid-market companies (50-500 employees) are underserved by both enterprise solutions and SMB tools**. Enterprise platforms (Coupa, SAP Ariba) are overbuilt and overpriced. SMB tools (BILL) lack the workflow sophistication needed at scale.
...
|---------|------|--------|---------|
| 1.0-8.0 | Jan-Feb 2026 | CPO | Initial drafts and iterations |
| 9.0 | Feb 1, 2026 | CPO | Consolidated execution-ready version |
