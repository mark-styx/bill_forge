...
const sheetVariants = cva(
  cn(
    'fixed z-50 gap-4 bg-card border-border shadow-soft-lg',
  ...
  ),
  {
    variants: {
      side: {
        ...
        right: cn(
          'inset-y-0 right-0 h-full w-3/4 border-l sm:max-w-md lg:max-w-lg',
...
const SheetFooter = ({
  ...
  <div
    className={cn(
      ...
      'p-6 border-t border-border bg-secondary/30',
      className
    )}
    {...props}
  />
