...
const personaGradients: Record<string, string> = {
  full_platform: 'from-blue-500 to-cyan-400',
  invoice_ocr_only: 'from-sky-500 to-blue-400',
  invoice_processing_only: 'from-emerald-500 to-teal-400',
  vendor_management_only: 'from-violet-500 to-purple-400',
  ap_lite: 'from-rose-500 to-orange-400',
};
  ...
  return (
    <div className="min-h-screen flex bg-gradient-to-br from-slate-50 via-white to-blue-50/30">
      ...
      <div className="hidden lg:flex lg:w-1/2 xl:w-2/5 relative overflow-hidden">
        <div className={`absolute inset-0 bg-gradient-to-br ${personaGradient} transition-all duration-500`} />
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 text-white">
          <div>
            <div className="flex items-center gap-3">
              ...
              <span className="text-xl font-semibold">BillForge</span>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <p className="text-white/80 text-lg max-w-md">
              Automate invoice processing, approvals, and vendor management with our modern AP platform.
            </p>
            
            <div className="flex flex-wrap gap-3 pt-4">
              {['OCR Capture', 'Smart Approvals', 'Vendor Portal', 'Analytics'].map((feature) => (
                <span key={feature} className="px-3 py-1.5 bg-white/15 backdrop-blur rounded-full text-sm font-medium">
                  {feature}
                </span>
              ))}
            </div>
          ...
          <div className="flex items-center gap-4 pt-8">
            ...
            <p className="text-sm text-white/80">
              Trusted by <span className="font-semibold text-white">500+</span> finance teams
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className={`w-full py-3 px-4 bg-gradient-to-r ${personaGradient} text-white font-medium rounded-xl shadow-lg shadow-primary/20 focus:outline-none focus:ring-2 focus:ring-primary/50 disabled:opacity-50 disabled:cursor-not-allowed transition-all hover:opacity-90 active:scale-[0.98]`}
              >
                {isLoading ? (
