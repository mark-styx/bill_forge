...
pub async fn run_banking_verification_migrations(pool: &PgPool) -> Result<()> {
    ...
    apply_migration(
        pool,
        "135_vendor_risk_alerts.sql",
        include_str!("../../../migrations/135_vendor_risk_alerts.sql"),
    )
    .await?;
    ...
    apply_migration(
        pool,
        "143_vendor_bank_country.sql",
        include_str!("../../../migrations/143_vendor_bank_country.sql"),
    )
    .await?;
